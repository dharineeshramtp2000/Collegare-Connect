...
String _comp = '';
String _companyname='';
class ChatListCompany extends StatefulWidget {

  @override
  _ChatListCompanyState createState() => _ChatListCompanyState();
}

class _ChatListCompanyState extends State<ChatListCompany> {
                        ...
                        return GestureDetector(
                          onTap: () {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => ChatWindow(sender: _comp, reciever: contactsList[index].contact,)));
                          },
                          child: Container(
                            height: 80.0,
                            color: Color(0xFFE7EFFA),
