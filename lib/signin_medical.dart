...
import 'package:company/screens/medical_shops/chat_shop.dart';
import 'package:company/signup_medical.dart';
      ...
      try {
        ...
        if (found==true) {
          ...
          if (user != null) {
            ...
            prefs.setString('shop_id', compEditingController.text);
//            SharedPreferences pref = await SharedPreferences.getInstance();
//            prefs.setString('company_name', ress.toString());
            Navigator.pushReplacement(
                context,
                MaterialPageRoute(builder: (context) => ChatShop()));
          }
        }
        else{
          setState(() {
